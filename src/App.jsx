...
export default function App() {
  ...
  var applyQuickView = function(view) {
    ...
    if (view === "active") setFStage(ACTIVE_STAGES.slice());
    else if (view === "all") setFStage([]);
    else if (view === "sold") setFStage(["Sold"]);
    else if (view === "lost") setFStage(["Lost"]);
    else if (view === "new") { setFStage(ACTIVE_STAGES.slice()); var now = new Date(); setDateFrom(now.getFullYear() + "-" + String(now.getMonth()+1).padStart(2,"0") + "-01"); setDateTo(""); }
    else if (view === "estimated") setFStage(["Estimated","Presented","Revised","Prepare To Close"]);
  };
