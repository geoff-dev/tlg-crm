...
const STALE_THRESHOLDS = {"Not Yet Contacted":{warn:1,overdue:2},"Discovered":{warn:3,overdue:5},"Qualified":{warn:5,overdue:8},"Visited":{warn:5,overdue:8},"Estimated":{warn:7,overdue:10},"Presented":{warn:10,overdue:15},"Revised":{warn:7,overdue:10},"Prepare To Close":{warn:3,overdue:5}};
const DEATH_REASONS = {
