...
function ManagementConsole({ onOpenProject }) {
  ...
  return (<div style={{display:"flex",flexDirection:"column",gap:16}}>
    ...
    <div style={{display:"flex",gap:6,flexWrap:"wrap",marginBottom:4}}>
      ...
      <div style={{width:1,background:"#d0cec7",margin:"2px 4px"}}></div>
      {navPill("goals","Goals")}
      {navPill("scorecard","Scorecard")}
      {navPill("thermometers","Goal Tracker")}
      {navPill("reports","Reports")}
      {navPill("history","Sales History")}
    </div>
  ...
  return (<div style={{maxWidth:1200,margin:"0 auto"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12,marginBottom:16,padding:"0 4px"}}>
      <div style={{display:"flex",alignItems:"center",gap:12}}>
        ...
        {projectView!=="home"&&<button onClick={function(){setProjectView("home");setSection("projects");setDetailView(null);}} style={{background:"none",border:"none",cursor:"pointer",fontSize:13,color:"#185FA5",fontWeight:600,padding:"4px 8px"}}>Home</button>}
      </div>
    ...
    {projectView==="home"&&<div>
      ...
      {mgmtUnlocked&&<div style={{padding:"16px 4px 0"}}><button onClick={function(){setProjectView("mgmtconsole");}} style={{padding:"8px 18px",borderRadius:10,border:"1px solid #1a1a1a",background:"#1a1a1a",color:"#fff",cursor:"pointer",fontSize:13,fontWeight:600}}>Management Console</button></div>}
    </div>}
