  ...
  function GoalRow({ cat, name, label }) {
    ...
    return (
      <tr style={{ borderBottom: "1px solid #f0eeea" }}>
        ...
        <td style={tdS}><input style={{...cellS, width: 120}} value={g.revenue_goal ? "$" + fmtRevGoal(g.revenue_goal) : ""} onChange={e => { const raw = e.target.value.replace(/[^0-9]/g, ""); setGoalField(cat, name, "revenue_goal", raw); }} placeholder="$0" /></td>
      </tr>
    );
  }
