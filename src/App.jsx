...
/* ══════════════════════════════════════════
   ...
   ══════════════════════════════════════════ */
/* ── Login Screen ── */
var TLG_MARK = "data:image/png;base64,";
...
function LoginScreen({ onLogin }) {
  ...
  return (<div style={{minHeight:"100vh",display:"flex",alignItems:"stretch",justifyContent:"center",background:"#f0f2f5"}}>
    <div style={{maxWidth:480,width:"100%",display:"flex",flexDirection:"column",overflow:"hidden",boxShadow:"0 0 40px rgba(36,63,129,0.12)"}}>
      <div style={{background:"#fff",flex:1,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"40px 24px 24px",textAlign:"center"}}>
        <img src={TLG_MARK} alt="The Lifestyle Group" style={{width:160,marginBottom:20}} />
        <div style={{fontSize:15,color:"#999",letterSpacing:"0.16em",textTransform:"uppercase",fontWeight:500,whiteSpace:"nowrap"}}>Customer Relationship Manager</div>
      </div>
      <div style={{background:"#243F81",padding:"28px 32px 40px",flexShrink:0}}>
        <div style={{fontSize:16,fontWeight:500,color:"#fff",marginBottom:4}}>Welcome back</div>
        <div style={{fontSize:12,color:"rgba(255,255,255,0.45)",marginBottom:20}}>Enter your PIN to continue</div>
