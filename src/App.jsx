...
var HIST_SOURCE = {
  "Angie's List / Angi":{2025:[0,0,0],2024:[1,1,0],2023:[2,2,0],2022:[2,2,0],2021:[6,6,0],2020:[70,68,1],2019:[141,140,1],2018:[168,140,27],2017:[108,78,12],2016:[185,121,0],2015:[275,196,1],2014:[312,192,0],2013:[279,153,1],2012:[255,140,1],2011:[239,117,5],2010:[163,97,4],2009:[111,90,8],2008:[163,138,8],2007:[81,62,9],2006:[228,159,31],2005:[254,176,37],2004:[242,138,34],2003:[307,0,0],2002:[214,0,0],2001:[369,0,0],2000:[338,0,0],1999:[0,0,0]},
...
function SalesHistory() {
  ...
  function renderDrillTable() {
    ...
    if (drillType === "source") {
      ...
      HIST_YEARS.forEach(function(y) {
        var d = srcData[y] || [0, 0, 0];
        if (d[0] > 0 || d[1] > 0 || d[2] > 0) drillRows.push({ year: y, leads: d[0], sold: d[1], rev: d[2] });
      });
      var ld = liveData ? (liveData.bySource[drillKey] || [0, 0, 0]) : [0, 0, 0];
      if (ld[0] > 0 || ld[1] > 0 || ld[2] > 0) drillRows.unshift({ year: curYear, leads: ld[0], sold: ld[1], rev: ld[2], live: true });
    }
  ...
  return (<div style={{display:"flex",flexDirection:"column",gap:20}}>
    ...
    <div style={{marginTop:16}}>
      <div style={{fontSize:12,fontWeight:600,color:"#8a8780",marginBottom:8,textTransform:"uppercase",letterSpacing:"0.06em"}}>By lead source</div>
      <div style={{display:"flex",gap:6,flexWrap:"wrap"}}>
...
function AuthenticatedApp({ authUser, onLogout }) {
  ...
  return (<div style={{maxWidth:1200,margin:"0 auto"}}>
    <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:12,marginBottom:16,padding:"0 4px"}}>
      <div style={{display:"flex",alignItems:"center",gap:12}}>
        <h1 style={{margin:0,fontSize:22,fontWeight:700,letterSpacing:"-0.03em",color:"#1a1a1a",cursor:"default",userSelect:"none"}}>TLG<span style={{color:"#185FA5",marginLeft:4}}>CRM</span></h1>
