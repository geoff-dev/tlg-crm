        ...
        employees.filter(function(e){return e.active;}).forEach(function(e) {
          var checkDate = function(dateStr, label, emoji) {
            ...
            if (diff <= 30) {
              ...
              upcoming.push({name: e.name, label: label, emoji: emoji, date: next, diff: diff, years: years});
            }
          };
