...
function EmployeePortal() {
  ...
  var renderForm = function() {
    return <div style={{display:"flex",flexDirection:"column",gap:16}}>
      ...
      <div style={{fontSize:12,fontWeight:700,color:"#8a8780",textTransform:"uppercase",letterSpacing:"0.06em"}}>Social Security</div>
      <div style={{display:"flex",flexWrap:"wrap",gap:10}}>
  ...
  var renderDetail = function() {
    ...
    return <div style={{display:"flex",flexDirection:"column",gap:16}}>
      ...
      {e.ssn_last4&&<>
        <div style={{fontSize:12,fontWeight:700,color:"#8a8780",textTransform:"uppercase",letterSpacing:"0.06em",marginTop:8}}>Social Security</div>
        <div style={{fontSize:14}}>***-**-{e.ssn_last4}</div>
      </>}
