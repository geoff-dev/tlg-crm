...
function OrderTracker({ projectId, contactId }) {
  ...
  var PHASES = ["Phase 1 — Demo & rough","Phase 2 — Plumbing rough","Phase 3 — Electrical rough","Phase 4 — Framing","Phase 5 — Drywall","Phase 6 — Cabinets","Phase 7 — Countertops","Phase 8 — Tile","Phase 9 — Flooring","Phase 10 — Trim","Phase 11 — Paint","Phase 12 — Final install","Phase 13 — Punch list","Other"];
  ...
  var renderForm = function() {
    return <div style={{display:"flex",flexDirection:"column",gap:14}}>
      ...
      <div style={{display:"flex",flexWrap:"wrap",gap:10}}>
        <Field label="Ordered by" half><select style={inpS} value={form.ordered_by||""} onChange={set("ordered_by")}><option value="">Select...</option>{TEAM.map(function(t){return <option key={t}>{t}</option>;})}</select></Field>
      ...
      <div style={{display:"flex",flexWrap:"wrap",gap:10}}>
        ...
        <Field label="Received by" half><select style={inpS} value={form.received_by||""} onChange={set("received_by")}><option value="">Select...</option>{TEAM.map(function(t){return <option key={t}>{t}</option>;})}</select></Field>
      ...
      <div style={{display:"flex",justifyContent:"flex-end",gap:8}}>
        ...
        <button onClick={saveItem} disabled={!form.item_name||saving} style={{...btnP,opacity:form.item_name?1:0.5}}>{saving?"Saving...":(detail?"Save changes":"Add item")}</button>
      </div>
    </div>;
  };
