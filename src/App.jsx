...
function OrderDashboard({ onOpenProject }) {
  ...
  var PHASES = ["Site Prep","Demo","Framing","Plumbing","Electrical","HVAC","Insulation","Drywall","Cabinetry","Cabinet Hardware","Countertops","Backsplash","Finish Carpentry","Flooring","Paint","Other"];
